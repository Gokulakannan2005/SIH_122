...
/**
 * Parse baseline schedule CSV text
 */
...
export function parseDailyReportTXT(txtText: string): SiteUpdate[] {
  ...
  lines.forEach((line, index) => {
    ...
    // Check for discipline section header
 ...
 */
export function parsePipingProgressXLSX(data: Buffer | ArrayBuffer | Uint8Array): SiteUpdate[] {
